...
//"this" is the Student constructor. It shows each part (name, age, hometown) with the values assigned under Student.
// 2. What is "this" when joe.scopeArrow() is invoked?
//It calls the constructor "Window" and does not give the correct values for the constructor Student. 
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions do not have their own "this", so are bad when used in methods
