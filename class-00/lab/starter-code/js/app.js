...
function displayPics(){
  ...
  // The console.log(rando) created a reference error because you accessed the variable before the initialization, which is displayPics(). Once you remove the console.log, the entirety of the code works again.
  console.log(viewed);
