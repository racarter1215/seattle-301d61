...
1. [jQuery Practice](./jquery_practice.md)
1. [Chocolate Pizza](./chocolate_pizza.md)
1. [Portfolio Prep](./portfolio_prep.md)

## Computer Setup

- [Windows WSL users](./computer_setup/wsl_env.md)
- [Mac and Linux users](./computer_setup/mac_linux_env.md)
